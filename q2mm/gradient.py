...
class Gradient(opt.Optimizer):
    ...
    def run(self, ref_data=None, restart=None):
        ...
        if self.do_lstsq or self.do_lagrange or self.do_levenberg or \
            ...
            #
            #
            # Updated section for Jacobian analysis
            #
            #
            
            logger.log(20, '~~ COPYING JACOBIAN VECTOR ~~'.rjust(79, '~'))
            ...
            logger.log(20, '~~ END ~~'.rjust(79, '~'))
            
            #
            #
            # End of updated section for Jacobian analysis
            # All other optimazation calculations removed past this point
            #
            #
